...
/// Basic spell checker - flags words not in a common word list
/// This is intentionally simple to avoid large dependencies
...
impl SpellChecker {
    pub fn new() -> Self {
        // Common English words list (top ~300 most frequent words)
        let words: &[&str] = &[
            ...
            "were", "said", "did", "am", "being", "having", "doing", "going", "making", "getting",
            "taking", "seeing", "very", "where", "through", "much", "before", "right", "too", "mean",
            "old", "any", "same", "tell", "does", "set", "three", "want", "air", "well", "also", "play",
            "small", "end", "put", "home", "read", "hand", "port", "large", "spell", "add", "even",
            "land", "here", "must", "big", "high", "such", "follow", "act", "why", "ask", "men",
            "change", "went", "light", "kind", "off", "need", "house", "picture", "try", "again", "animal",
            ...
            "hour", "better", "true", "during", "hundred", "five", "remember", "step", "early",
            ...
            "rest", "correct", "able", "pound", "done", "beauty", "drive", "stood", "contain",
            ...
            "distant", "fill", "east", "paint", "language", "among", "grand", "ball", "yet",
            ...
            "sand", "soil", "roll", "temperature", "finger", "industry", "value", "fight", "lie",
            "beat", "excite", "natural", "view", "sense", "ear", "else", "quite", "broke", "case",
            "middle", "kill", "son", "lake", "moment", "scale", "loud", "spring", "observe", "child",
            "straight", "consonant", "nation", "dictionary", "milk", "speed", "method", "organ",
            ...
            "provide", "agree", "thus", "capital", "chair", "danger", "fruit", "rich", "thick",
            "soldier", "process", "operate", "guess", "necessary", "sharp", "wing", "create",
            "neighbor", "wash", "bat", "rather", "crowd", "corn", "compare", "poem", "string",
            "bell", "depend", "meat", "rub", "tube", "famous", "dollar", "stream", "fear", "sight",
            "thin", "triangle", "planet", "hurry", "chief", "colony", "clock", "mine", "tie",
            "enter", "major", "fresh", "search", "send", "yellow", "gun", "allow", "print", "dead",
            "spot", "desert", "suit", "current", "lift", "rose", "continue", "block", "chart",
            "hat", "sell", "success", "company", "subtract", "event", "particular", "deal", "swim",
            "term", "opposite", "wife", "shoe", "shoulder", "spread", "arrange", "camp", "invent",
            "cotton", "born", "determine", "quart", "nine", "truck", "noise", "level", "chance",
            "gather", "shop", "stretch", "throw", "shine", "property", "column", "molecule",
            "select", "wrong", "gray", "repeat", "require", "broad", "prepare", "salt", "nose",
            "plural", "anger", "claim", "continent", "oxygen", "sugar", "death", "pretty", "skill",
            "women", "season", "solution", "magnet", "silver", "thank", "branch", "match", "suffix",
            "especially", "fig", "afraid", "huge", "sister", "steel", "discuss", "forward",
            "similar", "guide", "experience", "score", "apple", "bought", "led", "pitch", "coat",
        ...
        Self {
            common_words: words.iter().copied().collect(),
        }
    }

    pub fn check_text(&self, text: &str) -> HashSet<String> {
        ...
        for word in text.split_whitespace() {
            ...
            if self.common_words.contains(lower.as_str()) {
                continue;
            }
            
            // Flag as potentially misspelled
            misspelled.insert(cleaned);
        }
